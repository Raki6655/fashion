...
export function BrandStory() {
  ...
  return (
    <section ref={sectionRef} className="min-h-screen bg-black text-white py-32">
      <div className="max-w-7xl mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-24">
          ...
          <p className="text-xl text-neutral-400">
            Since 1925, we have been crafting exceptional garments that combine traditional
            craftsmanship with contemporary design. Our commitment to quality and innovation
            has made us a leader in luxury fashion.
          </p>
        </div>
