...
export function WomenSection() {
	...
	return (
		<section
			ref={sectionRef}
			id="women"
			className="min-h-screen bg-neutral-100 py-32"
		>
				...
				>
					...
					<div className="order-1 lg:order-2 space-y-8">
						...
						<p className="text-xl text-neutral-600">
							Elevate your wardrobe with our women&apos;s collection. From
							elegant evening wear to contemporary casual pieces, discover
