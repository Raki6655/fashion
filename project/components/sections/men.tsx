...
export function MenSection() {
	...
	return (
		<section
			ref={sectionRef}
			id="men"
			className="min-h-screen bg-neutral-900 text-white py-32"
		>
				...
				>
					<div className="space-y-8">
						...
						<p className="text-xl text-neutral-400">
							Discover our curated selection of premium menswear, from
							impeccably tailored suits to casual luxury essentials. Each piece
							embodies sophistication and style.
						</p>
