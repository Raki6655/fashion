...
const BRANDS = [
  'Gucci', 'Prada', 'Hermès', 'Louis Vuitton', 'Chanel', 'Dior', 
  'Saint Laurent', 'Balenciaga', 'Fendi', 'Burberry'
];
...
export function BrandMarquee() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const totalWidth = brandRefs.current.reduce((acc, el) => acc + el.offsetWidth + 64, 0); // 64px is the gap
